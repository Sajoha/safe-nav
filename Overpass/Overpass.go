...
func main() {
	...
	// response := httpReq("http://192.168.0.17/api/interpreter?data=[out:json];way(53.638207,-1.795287,53.653141,-1.753599);out;") // Small map of Huddersfield
	// response := httpReq("http://192.168.0.17/api/interpreter?data=[out:json];way(53.619325,-1.874757,53.666338,-1.714106);out;") // Larger map of Huddersfield
